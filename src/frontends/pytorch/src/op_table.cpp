...
const std::map<std::string, CreatorFunction> get_supported_ops_fx() {
    return {
        ...
        {"aten.index_put_.default", op::inplace_op<op::translate_index_put_>},
        ...
        {"aten.mul_.Tensor", op::inplace_op<op::translate_1to1_match_2_inputs_align_types<opset10::Multiply>>},
        ...
        {"aten.ones_like.default", op::translate_ones_like},
        ...
        {"aten.unsqueeze_.default", op::inplace_op<op::translate_1to1_match_2_inputs<opset10::Unsqueeze>>},
        ...
        {"aten.zeros.default", op::translate_zeros},
